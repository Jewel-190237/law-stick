                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6 items-center justify-between'>
                    ...
                    <div className=''>
                        ...
                        <div className='mt-12 flex gap-6'>
                            <button className='hover:bg-[#B68C5A] border border-[#B68C5A] text-black hover:text-white rounded-lg py-4 px-8 text-[18px] lato'>Read More</button>
                            <button className='hover:bg-[#B68C5A] border border-[#B68C5A] text-black hover:text-white rounded-lg py-4 px-8 text-[18px] lato'>Brows all services</button>
                        </div>
                    </div>
                </div>
            </div>
